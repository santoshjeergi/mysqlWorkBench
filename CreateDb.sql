...
-- For every order tell the number of products , quantity of products but only for thosse productrs wgich as atleaset 2 products 
-- we want by orderid >= 3

select order_id, COUNT(product_id) as NoOfProducts, SUM(quantity) as Quanity  
